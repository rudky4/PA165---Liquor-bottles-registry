...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/rest/laboratory/bottles").hasRole(PersonRole.LAB.name())
                .antMatchers(HttpMethod.GET, "/rest/store/*/bottles/all").hasRole(PersonRole.POLICE.name())
